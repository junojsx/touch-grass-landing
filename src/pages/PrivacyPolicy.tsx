    ...
    <div className="page legal">
      <div className="card legalCard">
        ...
        <section>
          ...
          <ul>
            <li>Data you enter in the app (e.g., task names and completion status) stored locally on your device.</li>
            <li>Anonymous usage analytics to improve the app, if you have opted in.</li>
          </ul>
          <p>
        ...
        <section>
          <h2>Third Parties</h2>
          <p>
            Our app may use third-party services (e.g., analytics). Those services have their own privacy policies. We encourage you to review them.
          </p>
        </section>
